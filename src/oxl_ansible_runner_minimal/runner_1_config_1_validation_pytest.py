...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'playbook_file': 'test.yml', 'playbook_dir': PATH_TEST, 'start_pipe_block_sec': 'abc'}),
        ({'playbook_file': 'test.yml', 'playbook_dir': PATH_TEST, 'start_pipe_block_sec': 1}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'playbook_file': 'test.yml', 'playbook_dir': PATH_TEST, 'start_pipe_block_sec': 7}),
